...
const Login = () => {
  // set title
  useTitle("Login");
  const { logInUser, providerSignIn, setLoading, loading } =
  ...
  const handleFormSubmit = (e) => {
    ...
    logInUser(email, password)
      .then((res) => {
        ...
        axios
          .post("https://assignment-11-two.vercel.app/jwt", currentUser)
          .then((res) => {
  ...
  return (
    <section>
      {loading ? (
        <div className="flex justify-center items-center mt-2 h-screen">
          ...
          <div className="hero-content flex-col lg:flex-row-reverse">
            ...
            <div className="card w-full md:w-1/2 shadow-2xl bg-base-100">
              ...
              <div className="flex justify-center mb-4">
                <button
                  className="btn btn-ghost text-yellow-400 rounded-full tooltip tooltip-top tooltip-error"
